...
<div class="aspNetHidden">
	...
	<option value="Jayadeva Flyover">Jayadeva Flyover</option>
            ...
            <div class="NotifyDiv">
                <span id="lblnotify" style="color:Red;font-size:10pt;"> </span>
            </div>
        ...
        <input type="hidden" name="Hiddenwaypoint" id="Hiddenwaypoint" />
        <input type="hidden" name="Hiddenwaypoint1" id="Hiddenwaypoint1" />
        <input type="hidden" name="Hiddenjuncnames" id="Hiddenjuncnames" />
        <input type="hidden" name="Hiddenjunctime" id="Hiddenjunctime" />
        <input type="hidden" name="Hiddeninfo_windowstring" id="Hiddeninfo_windowstring" />
    </div>
    </form>
</body>
</html>
